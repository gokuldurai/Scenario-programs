...
public class Flipkart {
	@Test
	public void AddToCartProductTest() throws InterruptedException, IOException {
...
//		
		...
		List<WebElement> date = driver.findElements(By.xpath("//a[@class='__-name']/ancestor::li[@class='list']/descendant::a[@class='showtime-pill']"));
